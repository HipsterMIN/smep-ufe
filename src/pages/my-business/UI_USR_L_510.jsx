      ...
      <td className="ac">
        {isDpaper ? (
          ...
          <button
            ...
            onClick={() =>
              window.open(
                `https://portal.smes.go.kr/e-page?prdocCd=${effectivePrdocCd}&prdocIssuAplyNo=${item.prdocIssuAplyNo}`,
                '_blank',
              )
            }
          >
            ...
            <>
              ...
              {!selectedIsDpaper && (
                <button
                  ...
                  onClick={() =>
                    window.open(
                      `https://portal.smes.go.kr/e-page?prdocCd=${popupEffectivePrdocCd}&prdocIssuAplyNo=${selectedItem.prdocIssuAplyNo}`,
                      '_blank',
                    )
                  }
                >
