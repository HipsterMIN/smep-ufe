        ...
        <div className="inner in-between">
          ...
          W3C (World Wide Web Consortium) 표준 중 CSS(Cascading Style Sheets)는 Level 2.1을 준수하여 W3C CSS Validation Service를 통과하였으며 HTML은 기본적으로 HTML5로 코딩을 하였으며 W3C Markup Validation Service를 통과하였습니다. 다만 외부 소스가 삽입된 경우는 HTML, CSS Validation Service를 통과하지 못 한 경우가 있습니다.
              ...
              <div className="btns-box">
                <a href="https://jigsaw.w3.org/css-validator/" target="_blank" rel="noreferrer" title="새 창 열림" className="krds-btn xsmall tertiary">CSS VALIDATION 바로가기</a>
                <a href="https://validator.w3.org/" target="_blank" rel="noreferrer" title="새 창 열림" className="krds-btn xsmall tertiary">MARKUP VALIDATION 바로가기</a>
              </div>
            </div>
          ...
          중소벤처기업부 기업마당 웹사이트는 앞으로도 장애인 사용자, 웹 접근성 전문가들의 의견을 청취하고, 웹 접근성 준수 여부를 지속 점검하여 접근성 100%준수를 위해 노력하겠습니다. <br />중소벤처기업부 기업마당 웹사이트의 웹 접근성 문제점을 발견하시는 이용자분께서는 언제든지 아래로 연락주시기 바랍니다. <br />(문의처 : 중소벤처기업부 정책분석평가과 최준영 / Tel : 044-204-7477)
            ...
            <div className="conts-wrap mt-48">
              ...
              <ul className="mt-16">
                <li>
                  <a href="https://www.nia.or.kr/" target="_blank" rel="noreferrer" title="새 창 열림" className="krds-btn medium text arrow-link">- 한국지능정보사회진흥원 <i className="svg-icon ico-angle right gray"></i></a>
                </li>
                <li>
                  <a href="https://www.tta.or.kr" target="_blank" rel="noreferrer" title="새 창 열림" className="krds-btn medium text arrow-link">- 한국정보통신기술협회 <i className="svg-icon ico-angle right"></i></a>
                </li>
              </ul>
            </div>
          </div>
