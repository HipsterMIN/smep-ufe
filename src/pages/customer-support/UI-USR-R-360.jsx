...
const UI_USR_R_360 = () => {
  const tabData = useRef(['지원사업소개', '증명서 발급', '기관/기업 조회', '정책금융안내']);
  ...
  const pageTitle = [...matches].reverse().find((match) => match?.handle?.menuNm)?.handle?.menuNm || '이용가이드';
      ...
      <div className="contents w-full">
        ...
        <div className="krds-tab-area layer">
          ...
          <div className="tab-conts-wrap mt-40">
            <div className={`tab-conts ${activeTabIndex === 0 ? 'active' : ''}`}>
            ...
            <div className={`tab-conts ${activeTabIndex === 1 ? 'active' : ''}`}>
            ...
            <div className={`tab-conts ${activeTabIndex === 2 ? 'active' : ''}`}>
            ...
            <div className={`tab-conts ${activeTabIndex === 3 ? 'active' : ''}`}>
