          ...
          <div className="conts-wrap mt-64">
            ...
            <div className="krds-table-wrap">
              ...
              <table className="tbl col data word-break t-block">
                ...
                <tbody>
                {[
                  { c: '0', m: '정상적으로 조회 되었습니다.', n: '정상' },
                  { c: '2', m: '데이터가 없습니다.', n: '정상' },
                  { c: '3', m: '확인서 발급기관과 연계 실패', n: '오류' },
                  { c: '9', m: '인증키 오류', n: '오류' },
                  { c: '99', m: '기타 오류 발생', n: '오류' },
                  { c: '429', m: '사용량이 많습니다. 잠시 후 이용해 주세요', n: '오류' }
                ].map((row, idx) => (
                    <tr key={idx}>
...
{`{
  ...
  "resultMsg": "정상적으로 조회되었습니다."
          ...
          {/* 하단 버튼 그룹: data-type="responsive" 및 mo-full 클래스 적용 */}
