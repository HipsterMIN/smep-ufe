  ...
  return (
    <>
      ...
      <div className="contents" data-type="responsive">
            ...
            <table className="tbl col data word-break t-block">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="ac" data-label="타입"><span>String</span></td>
                  <td className="ac" data-label="필수여부"><span>Y</span></td>
                  <td className="ac" data-label="샘플데이터"><span>Y104</span></td>
                  <td data-label="설명"><span>증명서코드 (메인비즈확인서 고정값)</span></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="conts-wrap mt-64">
          ...
          <div className="krds-table-wrap">
            <table className="tbl col data word-break t-block">
              ...
              <tbody>
                {[
                  { c: '0', m: '정상처리되었습니다.', b: '정상' },
                  { c: '2', m: '발급 가능한 증명서가 없습니다.', b: '정상' },
                  { c: '3', m: '연계기관 API 오류가 발생하였습니다.', b: '오류' },
                  { c: '5', m: '필수 파라미터 누락 또는 지원하지 않는 증명서 코드입니다.', b: '오류' },
                  { c: '10', m: '해당 API의 인증키가 아닙니다.', b: '오류' },
                  { c: '11', m: '존재하지 않는 인증키입니다.', b: '오류' },
                  { c: '12', m: '인증키가 필요합니다.', b: '오류' },
                ].map((row, idx) => (
                  <tr key={idx}>
        ...
        {/* 5. 단건 조회 예시 */}
        <div className="conts-wrap mt-40">
          <h3 className="sec-tit">메인비즈확인서 단건 조회 [증명서코드:Y104]</h3>
...

{
  ...
  "data": null
        ...
        {/* 6. 다건 조회 예시 */}
        <div className="conts-wrap mt-64">
          <h3 className="sec-tit">메인비즈확인서 다건 조회 [증명서코드:Y104]</h3>
          <p className="on-p2 mb-16">
              동일 증명서코드(Y104)에 대해 복수의 사업자번호를 일괄 발급합니다. 부분 실패가 허용되며, 건별 resultCd로 성공/실패를 구분합니다.
          </p>
