    ...
    <>
      ...
      <div className="contents" data-type="responsive">
        ...
        <div className="conts-wrap mt-64">
          ...
          <div className="krds-table-wrap">
            <table className="tbl col data word-break t-block">
              <caption>요청메시지: 파라미터명, 위치, 타입, 필수여부, 샘플데이터, 설명 정보</caption>
              <colgroup>
                <col style={{ width: '14%' }} />
                <col style={{ width: '10%' }} />
                <col style={{ width: '10%' }} />
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="ac" data-label="타입"><span>String</span></td>
                  <td className="ac" data-label="필수여부"><span>Y</span></td>
                  <td className="ac" data-label="샘플데이터"><span>Y106</span></td>
                  <td data-label="설명"><span>증명서코드 (벤처기업확인서 고정값)</span></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="conts-wrap mt-64">
          ...
          <div className="krds-table-wrap">
            <table className="tbl col data word-break t-block">
              ...
              <tbody>
                {[
                  { c: '0', m: '정상처리되었습니다.', r: '정상' },
                  { c: '2', m: '발급 가능한 증명서가 없습니다.', r: '정상' },
                  { c: '3', m: '연계기관 API 오류가 발생하였습니다.', r: '오류' },
                  { c: '5', m: '필수 파라미터 누락 또는 지원하지 않는 증명서 코드입니다.', r: '오류' },
                  { c: '10', m: '해당 API의 인증키가 아닙니다.', r: '오류' },
                  { c: '11', m: '존재하지 않는 인증키입니다.', r: '오류' },
        ...
        {/* 5. 단건 조회 예시 */}
        <div className="conts-wrap mt-40">
          <h3 className="sec-tit">벤처기업확인서 단건 조회 [증명서코드: Y106]</h3>
...

{
  ...
  "data": {
    ...
    "vnti_typ_nm": "",        // 벤처투자유형
    "rprsv_nm": "",           // 대표자명
    "hdofc_dtl_addr": "",     // 본점상세주소
    "vntr_end_vld_ymd": "",   // 벤처확인유효종료일자
    "vntr_bgng_vld_ymd": "",  // 벤처확인유효시작일자
  ...
  "data": null
        ...
        {/* 6. 다건 조회 예시 */}
        <div className="conts-wrap mt-64">
          <h3 className="sec-tit">벤처기업확인서 다건 조회 [증명서코드: Y106]</h3>
          <p className="on-p2 mb-16">
              동일 증명서코드(Y106)에 대해 복수의 사업자번호를 일괄 발급합니다. 부분 실패가 허용되며, 건별 resultCd로 성공/실패를 구분합니다.
          </p>
