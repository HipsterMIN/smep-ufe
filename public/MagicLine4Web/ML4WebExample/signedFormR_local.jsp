...
//			JCaosCheckCert jcaosCheck = new JCaosCheckCert();
			...
			// WildRain 수정 2024-02-16
			// 맥 환경에서 개발/테스트 가능하도록 경로 설정.
			// ※ 개발 환경에 맞게 경로 설정 필요.
			String sConfPath  			= "C:/eGovFrameDev-3.10.0-64bit/workspace/smbizvnentrprtl/src/main/webapp/WEB-INF/magicline/";   	// cofn경로, 앍고 쓰기 가능해야함
            ...
            String magiclineProperties  = sConfPath + "config/magicline_local.properties";
            String urlConfigProperties  = sConfPath + "conf/urlconfig_local.properties";
            String caEnvInfoConf        = sConfPath + "conf/ca_env_info_local.conf";  			//인증기관 LDAP정보

			//JCaosCheckCertInt jcaosCheck = new JCaosCheckCertInt(sConfPath+"config/jcaos.lic",sConfPath+"config/magicline.properties");
			...
			jcaosCheck.setCRL(true, urlConfigProperties);
			//jcaosCheck.setCertVerifyDir(sConfPath + "/conf");
            jcaosCheck.setCertVerifyDir(magiclineConfPath);
...
//				Date signedDate = jcaosCheck.getSignedTime(sSignData); // 인증시간
				...
				props.load(pageContext.getServletContext().getResourceAsStream("/MagicLine4Web/ML4Web/js/message/Messages.js"));
