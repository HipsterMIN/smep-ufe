...
function mlCallBack(code, message) {
	...
	if (code == 0) {
		...
		document.reqForm.encert.value = encodeURIComponent(message.certbag.signcert);
		document.reqForm.enpri.value = encodeURIComponent(message.certbag.signpri);

		if (message.certbag.kmcert != "undefined") {
			document.reqForm.enkmcert.value = encodeURIComponent(message.certbag.kmcert);
		}
		if (message.certbag.kmpri != "undefined") {
			document.reqForm.enkmpri.value = encodeURIComponent(message.certbag.kmpri);
		}
