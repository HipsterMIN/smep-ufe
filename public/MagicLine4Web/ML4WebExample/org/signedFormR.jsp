...
/* 	String scertData = null;
	String spriData = null;
	String skmcertData = null;
	String skpriData = null;
 */	
...
/* 	scertData = request.getParameter("encert");
	spriData = request.getParameter("enpri");
	
	skmcertData = request.getParameter("enkmcert");
	skpriData = request.getParameter("enkmpri");	
 */	
	sSignData = URLDecoder.decode(sSignData, "utf-8");
	
/*  	scertData = URLDecoder.decode(scertData, "utf-8");
	spriData = URLDecoder.decode(spriData, "utf-8");
	skmcertData = URLDecoder.decode(skmcertData, "utf-8");
	skpriData = URLDecoder.decode(skpriData, "utf-8");	 */
