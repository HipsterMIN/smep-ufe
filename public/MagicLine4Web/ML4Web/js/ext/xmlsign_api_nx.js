...
var magiclineXMLApi = function(){
	...
	function ML_funProcInitCheck (callback){
		...
		var childUrl = xml_mlMainUrl + xml_mlDirPath + xml_childHtml +"?lgUrl="+ xml_cpUrl +"&random=" + randomValue;
	...
	function MakeXMLDSIG(msg, callback, msgArray){
		...
		if(typeof(msgArray) !== "undefined" && typeof msgArray === "object"){
			param.msgArray = msgArray;
		}
