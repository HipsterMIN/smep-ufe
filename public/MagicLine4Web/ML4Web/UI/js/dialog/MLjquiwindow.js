...
(function(a) {
    ...
    a.extend(a.MLjqui._MLjquiWindow.prototype, {
        ...
        _addCloseButton: function() {
            if (!this._closeButton) {
                ...
                this._closeButton = a('<div style="width: 100%; height: 100%;" class="' + this.toThemeProperty("MLjqui-window-close-button") + " " + this.toThemeProperty("MLjqui-icon-close") + '" id="close_button"></div>');
    ...
    function b(e) {
        return !a(e).parents().addBack().filter(function() {
